    ...
    widgets: [
      {
        ...
        children: [
          ...
          ].map(([cmd, desc]) => ({ type: 'row', parts: [cmd, desc], fill: '.', pad: 1 })),
          { type: 'spacer' },
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    { type: 'spacer' },
                    { type: 'row', parts: ['GRAVITY', '[brwhite]0.9 g[/brwhite]'], fill: '.', pad: [1, 1] },
                    { type: 'row', parts: ['DAY', '[brwhite]24 h[/brwhite]'], fill: '.', pad: [1, 1] },
                    { type: 'row', parts: ['MOONS', '[brwhite]none[/brwhite]'], fill: '.', pad: [1, 1] },
                    { type: 'spacer' },
                    {
                      type: 'text',
