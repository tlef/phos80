...
Try `help`, `about`, `news 1`, `poster`, `map`, `code`, `theme green`, `effects scanlines 0.4`, `borders ascii`, `mode page` — then resize the window and watch the frames redraw at the new width.
